...
1. **报告位置**：`/home/chaos/work/hermes-agent/packages/ai-berkshire/reports/{行业名}-funnel-{YYYYMMDD}.md`（行业报告放 reports/ 根目录）
2. **语言**：中文
3. **风格**：直接、犀利、不说废话
...
python3 /home/chaos/work/hermes-agent/packages/ai-berkshire/tools/report_audit.py extract \
  --report /home/chaos/work/hermes-agent/packages/ai-berkshire/reports/{行业名}-funnel-{YYYYMMDD}.md
