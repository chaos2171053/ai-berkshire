...
在主会话中顺序完成2-3个研究视角，收集足够的素材，不启动后台 Agent：
...
初稿完成后，在主会话中先执行编辑审阅，再执行读者审阅，不启动后台 Agent。
...
| 类型 | 路径 | 命名格式 |
|------|------|---------|
| 技术主题 | `/home/chaos/work/hermes-agent/packages/ai-berkshire/reports/AI产业研究/` | `公众号-{主题关键词}-{YYYYMMDD}.md` |
| 投资主题 | `/home/chaos/work/hermes-agent/packages/ai-berkshire/reports/{公司名}/` | `{公司名}-公众号-{YYYYMMDD}.md` |
| 通用主题 | `/home/chaos/work/hermes-agent/packages/ai-berkshire/reports/` | `公众号-{主题关键词}-{YYYYMMDD}.md` |

写入后不要直接推送 main。为本次文章创建分支，提交 `/home/chaos/work/hermes-agent/packages/ai-berkshire/reports/...` 中新增或修改的文章文件，向 `chaos2171053/ai-berkshire:main` 创建 PR。随后将定稿正文交给 Hermes preview，向用户返回 PR 链接和 preview 链接。
