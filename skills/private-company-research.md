...
将完整最终报告写入 `/home/chaos/work/hermes-agent/packages/ai-berkshire/reports/{公司名}/{公司名}-private-{YYYYMMDD}.md`。如果 `/home/chaos/work/hermes-agent/packages/ai-berkshire/reports/{公司名}/` 目录不存在则创建。
